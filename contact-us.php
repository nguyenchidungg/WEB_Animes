          ...
          <nav class="navbar navbar-expand-lg  header__nav ">
              ...
              <div class="collapse navbar-collapse " id="navbarNavDropdown">
                  <ul class="navbar-nav navbar__menu">
                      ...
                      <li class="nav-item header__navbar-item">
                          <a class="nav-link header__navbar-item-link active" href="contact-us.php">Contact us</a>
                      </li>
                  </ul>
...
<div class="container">
    <div class="row contact__card">
        <div class="ourteam">
            <h2 class="ourteam__tittle text-center col-12">Meet our team</h2>
            <p class="ourteam__text text-center col-12">Yeah, we get it, there are times when you probably have some questions for us. If you need some help, we're always here. We’re always working to make your experience better and bring you the best of the content that you crave!</p>
            <div class="ourteam__devide mx-auto col-12"></div>
        </div>
        
        <div class="col-lg-4 col-md-6">
            <div class="mt-4 mb-4 p-3 d-flex justify-content-center">
                <div class="contact__card-item card p-4">
                    <div class=" image d-flex flex-column justify-content-center align-items-center"> 
                        <div class="circle btn"> <img src="https://www.bootdey.com/img/Content/avatar/avatar7.png"/></div> 
                        <span class="name mt-3">Vu Duy Di Dan</span> 
                        <span class="role">Member</span>
                        <div class="d-flex flex-row justify-content-center align-items-center gap-2"> 
                            <span class="contact-mail">18520614@gm.uit.edu.vn</span> 
                            <span></span> 
                        </div>
                        <div class=" d-flex mt-2"> <button class="btn btn-contact">Contact</button> </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6">
            <div class="mt-4 mb-4 p-3 d-flex justify-content-center">
                <div class="contact__card-item card p-4">
                    <div class=" image d-flex flex-column justify-content-center align-items-center"> 
                        <div class="circle btn"> <img src="https://www.bootdey.com/img/Content/avatar/avatar7.png"/></div> 
                        <span class="name mt-3">Nguyen Phan Hoang Duc</span> 
        ...
        <div class="col-lg-4 col-md-6">
            <div class="mt-4 mb-4 p-3 d-flex justify-content-center">
                <div class="contact__card-item card p-4">
                    <div class=" image d-flex flex-column justify-content-center align-items-center"> 
                        <div class="circle btn"> <img src="https://www.bootdey.com/img/Content/avatar/avatar7.png"/></div> 
                        <span class="name mt-3">Nguyen Chi Dung</span> 
                        <span class="role">Member</span>
                        <div class="d-flex flex-row justify-content-center align-items-center gap-2"> 
                            <span class="contact-mail">18520614@gm.uit.edu.vn</span> 
                            <span></span> 
