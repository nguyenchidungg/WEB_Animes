              ...
              <div class="collapse navbar-collapse " id="navbarNavDropdown">
                  <ul class="navbar-nav navbar__menu">
                      ...
                      <li class="nav-item dropdown header__navbar-item ">
                          <a class="nav-link dropdown-toggle header__menu-item-link header__navbar-item-link Categories active" href="categories.php" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Categories
                          </a>
    ...
    <div class="container">
        ...
        <main class="row">
            ...
            <article class="col-lg-8">
                <section class="post top-trending post-no-mb">
                    <div class="row">
                        <div class="col-12 post__tittle">
                            <h2 class="post__tittle-categories">Action</h2>
                            <div class="post__tittle__filter">
                                <p>Order by:</p>
                                <select>
                ...
                <div class="col-12 pagination">
                    ...
                    <a href="#">4</a>
                    <a href="#">5</a>
                    <a href="categories.php"><i class="fa fa-angle-double-right"></i></a>
                </div>
                <!-- Pagination End -->
            </article>
            <!-- Main Article End -->
