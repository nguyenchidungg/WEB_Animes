            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="sign__form">
                        ...
                        <form action="register_submit.php" method="POST">
                            ...
                            <div class="input__item">
                                <input type="password" placeholder="Comfirm password"name="repassword">
                                <span class="input__icon"><img src="./assets/images/icons/icon-confirm-pass.png"
                                        alt=""></span>
                            </div>
                            <div class="input__item">
                                <input type="email" placeholder="Email Address"name=email>
                                <span class="input__icon"><img src="./assets/images/icons/icon-email.svg" alt=""></span>
                            </div>
                            <div class="sign__checkbox">
                                <input type="checkbox" id="service" name="service" value="service">
                                <label for="service">I agree all statements in <a href="">Terms of service</a> </label>
                            </div>

                            <button type="submit" class="sign-btn btn" name="submit">SIGN UP NOW</button>
                        </form>
                ...
                <div class="col-lg-6">
                    <div class="sign__register">
                        ...
                        <a href="sign-in.php" class="sign-btn btn">SIGN IN NOW</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="sign__social__links">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="https://www.google.com/account" class="google"><i
