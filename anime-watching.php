          ...
          <div class="row">
              <div class="col-12">
                  <ul class="breadcrumb__links">
                      ...
                      <li><i class="fas fa-chevron-right"></i></li>
                      <li><a href="./categories.php">Slice of life</a></li>
                      <li><i class="fas fa-chevron-right"></i></li>
                      <li><span>Tawawa on Monday 2</span></li>
                  </ul>
              </div>
          </div>
      </div>

    <!-- Anime Player Begin preload="auto"-->
    <div class="row">
        <div class="col-12">
            <div class="anime__player">
              <video id="videoPlayer" class="video-js vjs-big-play-centered" data-setup="{}">
                ...
                <p class="vjs-no-js">Your brower does not support video player.</p>
              </video>
              <div class="control__player">
                <div class="control__player-left">
                  <div class="control__player-btn control__player-btn-autoplay">
                    <img src="./assets/images/icons/icon-checkbox.svg" alt="icon">
                    <span>Auto play</span> 
                  </div>
                  <a href="anime-watching.php" class="control__player-btn">
                    <img src="./assets/images/icons/icon-prev.svg" alt="icon">
                    <span>Prev</span> 
                  </a>
                  <a href="anime-watching.php" class="control__player-btn">
                    <span class="next">Next</span> 
                    <img src="./assets/images/icons/icon-next.svg" alt="icon">
                  </a>
                  <div class="control__player-btn control__player-btn-follow">
                    <img src="./assets/images/icons/icon-heart.svg" alt="icon">
                    <span>Follow</span> 
                  </div>
                  <div class="control__player-btn">
                    <img src="./assets/images/icons/icon-share.svg" alt="icon">
                    <span>Share</span> 
                  </div>
                </div>
                <div class="control__player-btn">
                  <img src="./assets/images/icons/icon-report.svg" alt="icon">
                  <span>Report</span> 
                </div>
              </div>

              <div class="alert alert-danger alert-dismissible fade show" role="alert">
                Estimated the next episode will come at 2021/11/07 14:00 GMT (<span id='countNewEp'></span>)
            ...
            <div class="anime__episodes">
                <div class="post__tittle">
                    <h2 class="post__tittle-categories">EPISODES</h2>
                </div> 
                <a href="#" class="ep-active">01</a>
                <a href="#">02</a>
                <a href="#">03</a>
                <a href="#">04</a>
                <a href="#">05</a>
    ...
    <main class="row">
      ...
      <article class="col-lg-8 col-md-8">
        <div class="post__comments">
          ...
          <div class="post__comments__item">
            <div class="post__comments__avatar">
              <img src="./assets/images/detail/review-5.jpg" alt="avatar">
            </div>
            <div class="post__comments__text">
              <h6>Chris Curry - <span>1 Hour ago</span></h6>
              <p>Finally it came out ages ago</p>
          ...
          <div class="post__comments__item">
            <div class="post__comments__avatar">
              <img src="./assets/images/detail/review-6.jpg" alt="avatar">
            </div>
            <div class="post__comments__text">
              <h6>Chris Curry - <span>1 Hour ago</span></h6>
